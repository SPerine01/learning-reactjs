    ...
    toDoDisplay: function () {
      return (
        ...
        React.createElement("li", {className: "todo"}, 
          ...
          React.createElement("button", {onClick: this.delete, className: "btn btn-default btn-sm glyphicon glyphicon-trash delete pull-right"})
    ...
    toDoForm: function () {
      return (
        ...
        React.createElement("li", {className: "todo"}, 
          ...
          React.createElement("button", {onClick: this.save, className: "btn btn-default btn-sm glyphicon glyphicon-trash delete pull-right"})
